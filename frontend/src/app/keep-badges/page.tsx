                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6">
                            The Badge Progress Overview only shows item types where you have added at least one item.
                            Below are all the item types where you haven't added any items yet - add items of these types to start earning badges!
                        </p>
                        ...
                        {unearnedItemTypes.length === 0 && (
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">
                                    Congratulations! You have items in all available categories and can earn all badge types.
                                </p>
                            </div>
                        )}
                    </div>
