                            ...
                            <div className="flex items-center space-x-2">
                                <div className="text-xs sm:text-sm">
                                    <SignInButton mode="modal">
                                        <button className="bg-white/20 hover:bg-white/30 text-white px-3 py-2 sm:px-4 sm:py-2 rounded-full transition-all duration-300 backdrop-blur-sm border border-white/20 text-xs sm:text-sm">
                                            Sign In
                                        </button>
                                    </SignInButton>
                                </div>
                                <div className="text-xs sm:text-sm">
                                    <SignUpButton mode="modal">
                                        <button className="bg-white text-teal-600 hover:bg-white/90 px-3 py-2 sm:px-4 sm:py-2 rounded-full transition-all duration-300 font-semibold text-xs sm:text-sm shadow-lg hover:shadow-xl">
                                            Sign Up
                                        </button>
                                    </SignUpButton>
                                </div>
